...
ActiveRecord::Schema[7.0].define(version: 2022_07_31_023643) do
  ...
  create_table "challenges", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: nil, null: false
    t.text "code"
    t.datetime "last_solution_at", precision: nil
  ...
  create_table "solutions", id: :serial, force: :cascade do |t|
    ...
    t.index ["user_id", "challenge_id"], name: "index_solutions_on_user_id_and_challenge_id", unique: true
