...
ActiveRecord::Schema.define(version: 20_170_210_022_151) do
  ...
  create_table "solutions", force: :cascade do |t|
    ...
    t.index %w(user_id challenge_id), name: "index_solutions_on_user_id_and_challenge_id", unique: true, using: :btree
